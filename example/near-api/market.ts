...
export function useMarketQueryRaw<Res = any, Req extends { [key: string]: any } = any>(
  methodName: MarketViewMethods,
  opts: Omit<NearQueryOptions<Res, Req>, 'contract'> = {}
) {
  const contract = useMarketContractId();
  return useNearQuery(methodName, { contract, ...opts });
}
export function useMarketMutationRaw<Res = any, Req extends { [key: string]: any } = any>(
